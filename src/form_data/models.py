...
class Admission(models.Model):
	full_name = models.OneToOneField(PatientProfile, on_delete=models.SET_NULL, null=True, blank=True)
...
class ApplicationForHomeLeave(models.Model):
	full_name = models.OneToOneField(PatientProfile, on_delete=models.SET_NULL, null=True, blank=True)
	ic_number = models.OneToOneField(Admission, on_delete=models.SET_NULL, null=True, blank=True)
