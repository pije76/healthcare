...
#	medication_tab_cap_mls = forms.ChoiceField(required=False, label="", widget=forms.Select(attrs={'class': "form-control"}), choices=TAB_CHOICES)
...
class MedicationAdministrationRecord_ModelForm_Set(BSModalModelForm):
	class Meta:
		model = MedicationAdministrationRecord
		fields = [
			'patient',
...
class MedicationAdministrationRecord_Model_Form_Set(forms.ModelForm):
	class Meta:
		model = MedicationAdministrationRecord
		fields = [
			'patient',
...
MedicationAdministrationRecord_ModelForm_Set = modelformset_factory(
	MedicationAdministrationRecord,
	form=MedicationAdministrationRecord_Model_Form_Set,
#	fields=(
#		'patient',
#		'medication_date',
#		'medication_time',
