...
class VitalSignFlow_ModelForm(BSModalModelForm):
    ...
    temp = forms.DecimalField(required=False, label="", initial=default_desimal, min_value=0.0,
                              widget=forms.NumberInput(attrs={'class': "form-control", 'step': 0.01}))
    pulse = forms.IntegerField(required=False, label="", initial=default_desimal,
    ...
    blood_pressure_diastolic = forms.IntegerField(
        required=False, label="", initial="0", min_value=0, widget=forms.NumberInput(attrs={'class': "form-control"}))
    respiration = forms.IntegerField(required=False, label="", initial="0",
                                     min_value=0, widget=forms.NumberInput(attrs={'class': "form-control"}))
    spo2_percentage = forms.IntegerField(
        required=False, label="", initial="0", min_value=0, widget=forms.NumberInput(attrs={'class': "form-control"}))
    spo2_o2 = forms.IntegerField(required=False, label="", initial="0",
                                 min_value=0, widget=forms.NumberInput(attrs={'class': "form-control"}))
...
#    temp = forms.DecimalField(required=False, label="", initial="0", min_value=0.0, widget=forms.NumberInput(attrs={'class': "form-control"}))
    temp = forms.DecimalField(required=False, label="", initial=default_desimal,
                              widget=forms.NumberInput(attrs={'class': "form-control", 'step': 0.01}))
    pulse = forms.IntegerField(required=False, label="", initial="0",
                               min_value=0, widget=forms.NumberInput(attrs={'class': "form-control"}))
    blood_pressure_systolic = forms.IntegerField(
        required=False, label="", initial="0", min_value=0, widget=forms.NumberInput(attrs={'class': "form-control"}))
    blood_pressure_diastolic = forms.IntegerField(
