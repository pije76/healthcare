...
#	themes = response.session.get('theme')
    ...
    result = generate_pdf('patient/application_home_leave/application_home_leave_pdf.html',
...
def ticket(request, id):
    ...
    response = HttpResponse(
        pdf_ticket['content'], content_type=pdf_ticket['mimetype'])
...
def ticket_to_pdf(visitor, event):
    ...
    ticket = render(
        'patient/application_home_leave/application_home_leave_pdf.html', context)
