...
def medication_administration_template_list(request, username):
    ...
    patients = MedicationAdministrationRecordTemplate.objects.filter(
        patient=patientid)
...
def medication_administration_template_create(request, username):
    ...
    mart_profiles = MedicationAdministrationRecordTemplate.objects.filter(
        patient=patientid)
    templates = MedicationAdministrationRecordTemplate.objects.filter(
        patient=patientid).values_list('medication_time')
    patients_templates = MedicationAdministrationRecordTemplate.objects.filter(patient=patientid).filter(medication_time__in=[
        '00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00']).order_by("medication_time")
    themes = request.session.get('theme')
    ...
    if request.method == 'POST':
        formset = MedicationAdministrationRecordTemplate_FormSet(
        ...
        formset = MedicationAdministrationRecordTemplate_FormSet(
            initial=initial_mart_formset, queryset=patients_templates)
