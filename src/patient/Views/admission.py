...
def admission_list(request, username):
	...
	admissionform = Admission.objects.filter(patient=patientid).exclude(date_diagnosis__isnull=True)
...
#            own_medication_mar.medication_date = martform_own_medication.cleaned_data['medication_date']
			...
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time0)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time0))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time1)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time1))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time2)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time2))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time3)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time3))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time4)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time4))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time5)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time5))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time6)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time6))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time7)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time7))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time8)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time8))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time9)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time9))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time10)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time10))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time11)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time11))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time12)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time12))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time13)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time13))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time14)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time14))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time15)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time15))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time16)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time16))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time17)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time17))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time18)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time18))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time19)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time19))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time20)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time20))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time21)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time21))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time22)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time22))
			if MedicationAdministrationRecord.objects.filter(patient=patients).filter(medication_time=str(get_medication_mart_time23)).exists():
				...
				own_medication_mar.medication_time = MedicationAdministrationRecord.objects.create(patient=patients, medication_time=str(get_medication_mart_time23))
