...
#    path('admission/<username>/', admission, name='admission_create'),
    ...
    path('<username>/discharge-checklist/', discharge_checklist_list, name='discharge_checklist_list'),
    ...
    path('<username>/investigation-report/', investigation_report_list, name='investigation_report_list'),
    ...
    path('<username>/medication-administration-template/', medication_administration_template_list, name='medication_administration_template_list'),
    path('<username>/medication-record/', medication_record_list, name='medication_record_list'),
    ...
    path('<username>/physio-progress-note-sheet/', physio_progress_note_sheet_list, name='physio_progress_note_sheet_list'),
    ...
    path('<username>/visiting-consultant/', visiting_consultant_list, name='visiting_consultant_list'),
...
#   path('application-application-home-leave/<username>/autocomplete/', autocomplete.Select2QuerySetView.as_view()_create, name='autocomplete_application_home_leave_create'),
    ...
    path('discharge-checklist/<username>/', discharge_checklist_create, name='discharge_checklist_create'),
    ...
    path('investigation-report/<username>/', investigation_report_create, name='investigation_report_create'),
    ...
    path('medication-administration-template/<username>/', medication_administration_template_create, name='medication_administration_template_create'),
    ...
    path('physio-progress-note-sheet/<username>/', physio_progress_note_sheet_create, name='physio_progress_note_sheet_create'),
    ...
    path('visiting-consultant/<username>/', visiting_consultant_create, name='visiting_consultant_create'),
