...
#	duration_time_to = models.DurationField(blank=True, null=True)
    ...
    checked_sign_by = models.ForeignKey(
        UserProfile, related_name='checked_sign_by_overtimeclaim', on_delete=models.CASCADE, blank=True, null=True)
    verify_by = models.ForeignKey(UserProfile, related_name='verify_by_overtimeclaim',
                                  default=None, on_delete=models.CASCADE, blank=True, null=True)
...
class StaffRecords(models.Model):
    ...
    replacement_public_holiday = models.PositiveIntegerField(
    ...
    emergency_leaves_reasons = models.CharField(
        max_length=255, blank=True, null=True)
    unpaid_leaves = models.CharField(max_length=255, blank=True, null=True)
    unpaid_leaves_reasons = models.CharField(
        max_length=255, blank=True, null=True)
